...
public class CadastrosClientesController implements Initializable {
    ...
    public void selecionarItemTableViewClientes(Cliente cliente){
        if (cliente != null) {
            ...
            labelClienteDataNascimento.setText(cliente.getData_nascimento());
        } else {
    ...
    public boolean showFXMLAnchorPaneCadastrosClientesDialog(Cliente cliente) throws IOException {
        ...
        loader.setLocation(CadastrosClientesDialogController.class.getResource("/javafxmvc/view/FXMLAnchorPaneCadastrosClientesDialog.fxml"));
